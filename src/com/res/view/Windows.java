...
public class Windows extends JFrame implements ActionListener, MouseListener {
    ...
    //其余菜单的二级图标
    ImageIcon jm2_icon1, jm3_icon1, jm4_icon1, jm5_icon1, jm6_icon1, jm6_icon2, jm6_icon3;
    ...
    public void initMenu() {
        ...
        //创建其余菜单的二级图标
        jm2_icon1 = new ImageIcon("image/jm2_icon1.jpg");
        jm3_icon1 = new ImageIcon("image/jm3_icon1.jpg");
        jm4_icon1 = new ImageIcon("image/jm4_icon1.jpg");
        jm5_icon1 = new ImageIcon("image/jm5_icon1.jpg");
        jm6_icon1 = new ImageIcon("image/jm6_icon1.jpg");
        jm6_icon2 = new ImageIcon("image/jm6_icon2.jpg");
        jm6_icon3 = new ImageIcon("image/jm6_icon3.jpg");
        ...
        jm2_1 = new JMenuItem("人事登记", jm2_icon1);
    ...
    public void initJp5() {
        ...
        //创建Timer
        t = new Timer(1000, this);//每隔一秒，去触发一个ActionEvent事件
        //启动定时器
        t.start();
        //创建显示时间标签
