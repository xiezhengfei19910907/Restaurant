...
public class UpdateEmpInfo extends JDialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == jb1) {	// 添加
            String[] params = {jtf2.getText(), jtf3.getText(), jtf4.getText(), jtf5.getText(), jtf6.getText(), jtf7.getText(), jtf8.getText(), jtf9.getText(), jtf1.getText()};
            EmpModel empModel = new EmpModel();
            if (empModel.updateEmpInfo(params)) {
